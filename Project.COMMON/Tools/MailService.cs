...
namespace Project.COMMON.Tools
{
    ...
    {
        public static void Send(string receiver,string password="n.ceren097",string body="Test mesajıdır",string subject="Email Testi",string sender="naciye.ceren097@gmail.com")
        {
